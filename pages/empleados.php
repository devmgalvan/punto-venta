...
$sql="SELECT * FROM `basecelulares`.`proveedores` WHERE cif='$ci'";
...
if($var6>1){
	  ...
	  echo '<div class="alert alert-danger alert-dismissable">
                                        ...
                                        <b>¡El usuario registrado ya existe!</b> ';
...
$sql = "INSERT INTO `basecelulares`.`proveedores` (`cif`, `nombre`, `apellido`, `correo`, `fechai`) VALUES ('$ci', '$nombre', '$apellido', '$correo', '$fechai')";
                                ...
                                <form role="form"  name="fe" action="?mod=empleados&nuevo=nuevo" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input onkeydown="return enteros(this, event)" required type="text" name="ci" class="form-control" value="<?php echo $var1 ?>" id="exampleInputEmail1" placeholder="Cif">
...
if($var6>1){
      ...
      echo '<div class="alert alert-danger alert-dismissable">
                                        <i class="fa fa-check"></i>
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                        <b>¡Usuario no registrado, ya existe! </b> ';
...
?>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        $consulta="SELECT cif, nombre, apellido, correo FROM proveedores ORDER BY cif ASC ";
      ...
      <a  href=editar.php?codigo=".$fila["cif"]."><img src='./img/editar.png' width='25' alt='Edicion' title='Editar los datos de ".$fila["nombre"]."'></a> 
      <a   href=editar.php?codigo=".$fila["cif"]."><img src='./img/elimina.png'  width='25' alt='Edicion' title='Eliminar a   ".$fila["nombre"]."'></a>
      ";}
      echo "
      
      <a target='_blank'  href=./pdf/prestacionespdfbien.php?codigo=".$fila["cif"]."><img src='./img/impresora.png'  width='25' alt='Edicion' title='Imprimir reporte de prestaciones de  ".$fila["nombre"]."'></a>
...
INNER JOIN lugares ON admin_lugares.id_lugares = lugares.id_lugar*/
 ...
 <input title="Agregar nuevo empleado" name="btn1"  class="btn btn-primary"type="submit" value="Agregar nuevo">
