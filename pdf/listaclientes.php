...
$mipdf->Ln(2);
$mipdf->Cell(190, 10, "Lista de Proveedores $fecha", 0, 0, 'C');
$mipdf->Ln(10);
...
$mipdf->SetFont('ARIAL', 'B', 8);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(20, 11, "CIF", 1, 0, 'C', true);
$mipdf->SetFont('ARIAL', 'B', 8);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(65, 11, "Nombre", 1, 0, 'C', true);

$mipdf->SetFont('ARIAL', 'B', 8);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(30, 11, "Poblacion", 1, 0, 'C', true);

$mipdf->SetFont('ARIAL', 'B', 8);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(48, 11, "Correo", 1, 0, 'C', true);
...
//ya no habría mas condiciones, ahora simplemente restamos los años y mostramos el resultado como su edad
    ...
    $mipdf->Cell(20, 5, "$cif", 1, 0, 'C');
    $mipdf->CellFitSpace(65, 5, "$nombre", 1, 0, 'C');

    $mipdf->Cell(30, 5, "$poblacion", 1, 0, 'C');
    $mipdf->Cell(48, 5, "$p", 1, 0, 'C');
