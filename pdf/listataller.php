...
$mipdf->Ln(2);
$mipdf->Cell(200, 10, "Lista de Productos $fecha", 0, 0, 'C');
$mipdf->Ln(10);
...
$mipdf->SetFont('ARIAL', 'B', 8.5);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(35, 11, "Producto", 1, 0, 'C', true);
$mipdf->SetFont('ARIAL', 'B', 8.5);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(40, 11, "Modelo", 1, 0, 'C', true);
...
$mipdf->SetFont('ARIAL', 'B', 8.5);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(20, 11, "N Serie", 1, 0, 'C', true);
$mipdf->SetFont('ARIAL', 'B', 8.5);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(40, 11, "Problema", 1, 0, 'C', true);
...
//ya no habría mas condiciones, ahora simplemente restamos los años y mostramos el resultado como su edad
    ...
    $mipdf->CellFitSpace(35, 5, "$tipo", 1, 0, 'C');
    $mipdf->Cell(40, 5, "$nombre", 1, 0, 'C');
    $mipdf->Cell(25, 5, "$marca", 1, 0, 'C');

    $mipdf->Cell(20, 5, "$num2", 1, 0, 'C');
    $mipdf->CellFitSpace(40, 5, "$estado", 1, 0, 'C');
