        ...
        if ($mostrar = $bd->mostrar_registros()) {
            ...
            echo '<div class="form-box">
                        <div class="alert alert-warning alert-dismissable">
                                        ...
                                        <b>Inicio de Sesión !</b>  Usuario o contraseña incorrectos. Intentelo de nuevo.
                                    </div>
                                </div>';
        }
    }
...
//Enviamos el mensaje a tu_dirección_email
                    ...
                    echo '<div class="form-box">
                                    <div class="alert alert-warning alert-dismissable">
                                        <i class="fa fa-warning"></i>
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                        <b>Recuperar Contraseña !</b>No se recuperaron sus datos correctamente en el correo: '.$destino.' no  se encuentra registrado
                                    </div>
                                </div>';
                }
            }
        ...
        <form  name="frmLogin" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="body bg-gray">
                ...
                <div class="form-group">
                    <input type="checkbox" name="remember_me"/> Recordar credenciales
                </div>
            </div>
            <div class="footer">
        ...
        <center>
            <button type="submit" name="" data-toggle="modal" data-target="#myModal" class="btn bg-olive btn-block">¿Olvidaste tu contraseña?</button>
